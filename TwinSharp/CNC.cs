...
namespace TwinSharp
{
    public class CNC : IDisposable
    {
        ...
        internal AdsClient geoClient;
        internal AdsClient sdaClient;
        internal AdsClient comClient;
        ...
        public CNC(AmsNetId target) 
        {
            ...
            {
                Axes[i] = new CncAxis((uint)(i + 1), target);
            }
        }
        ...
        private static void CreateGeoDictionary()
        {
